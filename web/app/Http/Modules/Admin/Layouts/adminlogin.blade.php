				...
				<div class="single-inner-padding text-center">
					...
					<form role="form" action="" method="post">
						<div class="form-group form-input-group m-t-30 m-b-5">
							<input type="email" name="email" class="form-control input-lg font-14" placeholder="Email Address">
							<input type="password" name="password" class="form-control input-lg font-14" placeholder="Password">
						</div>
