    ...
    <header class="header-top navbar">
        ...
        <div class="collapse navbar-collapse" id="headerNavbarCollapse">
            <ul class="nav navbar-nav">
                <li class="hidden-xs"><a href="#" class="font-lg sidenav-size-toggle"><i
                                class="icon-indent-decrease inline-block"></i></a></li>
                <li class="dropdown">
            ...
            <ul class="side-nav magic-nav">
                ...
                <li class="has-submenu">
                    ...
                    <div class="sub-menu collapse secondary list-style-circle" id="business">
                        <ul>
                            <li><a href="/admin/add_business/{{Auth::user()->id}}" class="animsition-link">Add
                                    Business</a></li>
                            ...
                            <li><a href="/admin/unapproved_business" class="animsition-link">UnApproved Business</a>
                            </li>
                        </ul>
                    </div>
                </li>
