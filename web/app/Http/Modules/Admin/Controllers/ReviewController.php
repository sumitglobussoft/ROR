...
//       $array=array("Bake Shops","Catering","Coffee Shops & Tea Rooms","Deli's","Fast Food Restaurants","Food Vendors","Ice Cream Shops","Pizza & Take Out","Restaurant Delivery Services","Restaurants");
//        $objCategory = new category();
//         $category = $objCategory->putCategory($array);
//         die;
        $userid = Auth::user()->id;
        if ($data->isMethod('post')) {
