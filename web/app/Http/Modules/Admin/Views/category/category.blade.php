                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="/admin/updatecategory" method="post" role="form">
                            ...
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <select class="form-control input-lg font-14" name="editcategorystatus"
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-right">
                            <a class="btn btn-primary" data-toggle="modal" href="#addModal"> <i class="fa fa-plus"></i>
                                Add Category </a>
                        </div>
                                ...
                                @if(sizeof($category_data) > 0)
                                    ...
                                    @foreach($category_data as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:;" data-toggle="modal" id="{{$data->category_id}}"
                                                   data-category="{{$data->category_name}}"
                                                   data-status="{{$data->status}}" class="btn btn-info edit-category">
                                                    <i class="fa fa-pencil"></i> </a>
                                                <a href="javascript:;" data-toggle="modal" id="{{$data->category_id}}"
                                                   data-category="{{$data->category_name}}"
                                                   data-status="{{$data->status}}"
                                                   class="btn btn-danger delete-category"> <i class="fa fa-trash"></i>
                                                </a>
                                                <a href="/admin/subcategory/{{$data->category_id}}" data-toggle="modal"
                                                   id="{{$data->category_id}}" data-category="{{$data->category_name}}"
                                                   data-status="{{$data->status}}" class="btn btn-info"> <i class="fa">View
                                                        Sub-Category </i> </a>
                                            </td>
                                        </tr>
                                        <?php $index++; ?>
        ...
        <div class="modal-content">
            ...
            <form action="/admin/addcategory" method="post" role="form">
                <div class="modal-body">
                    <div class="form-group form-input-group m-t-30 m-b-5">
                        <input type="text" name="category" class="form-control input-lg font-14"
