                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="/admin/updatesubcategory" method="post" role="form" >
                            ...
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <input type="hidden" name="editsubcategoryid" id="editsubcategoryid" class="form-control input-lg font-14" placeholder="User ID" value="" />
                            </div>
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <input type="text" name="editsubcategoryname" id="editsubcategoryname" class="form-control input-lg font-14" placeholder="Username" value="" required/>
                            </div>
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <select class="form-control input-lg font-14" name="editsubcategorystatus" id="editsubcategorystatus">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-left">
                            <a href="/admin/category" class="btn btn-primary" > <i class="fa fa-back"></i>Back to Category </a>
                        </div> 
                          <div class="text-left">
                              <h2> Category  :  {{$category_name}} </h2>
                        </div>
                        <div class="text-right">
                            <a class="btn btn-primary addsubcategory" data-toggle="modal" id="{{$category_id}}" > <i class="fa fa-plus"></i> Add sub-Category </a>
                        </div>
...
<!--                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:;" data-toggle="modal" id="{{$data->subcategory_id}}" data-category-id="{{$data->category_id}}" data-subcategory="{{$data->subcategory_name}}" data-substatus ="{{$data->status}}" class="btn btn-info edit-subcategory"> <i class="fa fa-pencil"></i> </a>
                                            <a href="javascript:;" data-toggle="modal" id="{{$data->subcategory_id}}" data-category-id="{{$data->category_id}}" data-subcategory="{{$data->subcategory_name}}" data-substatus ="{{$data->status}}" class="btn btn-danger delete-subcategory"> <i class="fa fa-trash"></i> </a>
        ...
        <div class="modal-content">
            ...
            <form action="/admin/addsubcategory" method="post" role="form">
                <div class="modal-body">
                    <div class="form-group form-input-group m-t-30 m-b-5">
                        <input type="text" name="subcategory" class="form-control input-lg font-14" placeholder="Category Name" required>
                    </div>
                     <div class="form-group form-input-group m-t-30 m-b-5">
                        <input type="hidden" name="addcategoryid" id="addcategoryid" class="form-control input-lg font-14" placeholder="Sub Category Name" required>
                    </div>
                    <div class="form-group form-input-group m-t-30 m-b-5">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="/admin/deletesubcategory" method="post" role="form">
                <div class="modal-body">
                    <div class="form-group form-input-group m-t-30 m-b-5">
                        <input type="hidden" id="deletesubcategoryid" name="deletesubcategoryid" class="form-control input-lg font-14" />
                    </div>
                     <div class="form-group form-input-group m-t-30 m-b-5">
