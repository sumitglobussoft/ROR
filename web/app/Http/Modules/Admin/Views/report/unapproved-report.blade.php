...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Unapproved Reports</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tbody>
                                @if(isset($unapproved_report_data))
                                    @if(sizeof($unapproved_report_data) > 0)
                                        <?php $index = 1; ?>
                                        @foreach($unapproved_report_data as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="changestatus" data-report-id="{{$data->report_id}}"
                                                            class="changestatus" name="changestatus">
                                                ...
                                                <td class="btn-group text-center">
                                                    <a href="javascript:;" data-toggle="modal" id="{{$data->report_id}}"
                                                       class="btn btn-info edit-report padd-10"> <i
                                                                class="fa fa-pencil"></i> </a>
                                                    <a href="javascript:;" data-toggle="modal" id="{{$data->report_id}}"
                                                       class="btn btn-danger delete-report padd-10"> <i
                                                ...
                                                <td>
                                                    <a href="/admin/review/{{$data->report_id}}" class="btn btn-info ">
                                                        <i class="fa">View Reviews</i> </a>
                                                </td>
                                                <td>
                                                    <a href="/admin/viewreport/{{$data->report_id}}"
                                                       class="btn btn-info "> <i class="fa">View Details</i> </a>
                                                </td>
                                            </tr>
                                            <?php $index++; ?>
                                        @endforeach
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="/admin/changereportstatus" method="post" role="form">
                    <div class="modal-body">
                        <div class="form-group form-input-group m-t-30 m-b-5">
                            <input type="hidden" id="changereportid" name="changereportid"
                                   class="form-control input-lg font-14"/>
                        </div>
                        <div class="form-group form-input-group m-t-30 m-b-5">
