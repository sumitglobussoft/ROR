                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                             <a href="javascript:;" data-toggle="modal" id="{{$report_data['report_id']}}"  class="btn btn-info edit-report padd-10"> <i class="fa fa-pencil">Edit This Report</i> </a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_default_1">
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Company Name or Individual:</label> <span>{{$report_data['company_or_individual_name']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Additaional Names:</label> <span>{{$report_data['company_or_individual_aka']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Web Address:</label> <span>{{$report_data['web_address']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                ...
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Street:</label> <span> {{$report_data['street_address']}}  </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>City:</label> <span> {{$report_data['city']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>State/Province:</label> <span> {{$report_data['state']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                ...
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Email Address:</label> <span>{{$report_data['email_address']}} </span>                       
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="tab_default_2">
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Report Title :</label> <span>{{$report_data['report_title']}} </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Category :</label> <span>{{$report_data['category_name']}}  </span>                       
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
                                                    <label>Sub-Category :</label> <span>{{$report_data['subcategory_name']}} </span>                       
                                                </div>
                                            ...
                                            <div class="tab-pane" id="tab_default_3">
                                                <div class="form-group form-input-group m-t-30 m-b-5 col-md-10">
                                                    <label>Report:</label>
                                                    <span id="originalreport" class="originalreport"><?php echo $report_data['report_text']; ?></span>
                                                </div>
                                                <div class="form-group form-input-group m-t-30 m-b-5">
