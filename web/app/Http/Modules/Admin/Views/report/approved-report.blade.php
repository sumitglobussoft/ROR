...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Approved Reports</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tbody>
                                @if(isset($approved_report_data))
                                    @if(sizeof($approved_report_data) > 0)
                                        <?php $index = 1; ?>
                                        @foreach($approved_report_data as $data)
                                            <tr>
