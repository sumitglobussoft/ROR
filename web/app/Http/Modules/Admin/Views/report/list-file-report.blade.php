...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Reports</div>
                                ...
                                @if(sizeof($report_data) > 0)
                                    ...
                                    @foreach($report_data as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/review/{{$data->report_id}}" class="btn btn-info "> <i
                                                            class="fa">View Reviews</i> </a>
                                            </td>
                                            <td>
                                                <a href="/admin/viewreport/{{$data->report_id}}" class="btn btn-info ">
                                                    <i class="fa">View Details</i> </a>
                                            </td>
                                        </tr>
                                        <?php $index++; ?>
                                    @endforeach
