                            ...
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="full_name" id="full_name"
                                           value="<?php echo $AdminData->full_name;?>"
                            ...
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="display_name" id="display_name"
                                           value="<?php echo $AdminData->display_name;?>"
                            ...
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="address" id="editaddress"
                                           ...
                                           value="<?php echo $AdminData->address;?>"/>
                                </div>
                            </div>
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                            ...
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="state" id="editstate"
                                           ...
                                           value="<?php echo $AdminData->state;?>"/>
                                </div>
                            </div>
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                            ...
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="zipcode" id="editzipcode"
                                           ...
                                           value="<?php echo $AdminData->zipcode;?>"/>
                                </div>
                            </div>
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="primary_phone" id="editprimary_phone"
                                           ...
                                           value="<?php echo $AdminData->primary_phone;?>"/>
                                </div>
                            </div>
                            <div class="form-group form-input-group m-t-10 m-b-5 pull-left col-md-6">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="alternate_phone" id="editalternate_phone"
                                           value="<?php echo $AdminData->alternate_phone;?>"
