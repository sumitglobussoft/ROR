...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Business User Details</div>
    <div class="content-wrap">
        <div class="row editUser">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="title ">Edit Business User</div>
                    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="" role="form" id="joinUserForm">
                            ...
                            <div class="form-group col-md-12 m-t-10">
                                <div class="pull-right">
                                    <button type="button" class="btn btn-main" id="userjoin">Add Business User</button>
                                    <button type="button" class="btn btn-dark add-toggle">Cancel</button>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($userDetails->business_login_active==0)
                                            <label class="label label-danger">Deactive</label>
                                        @endif
                                        @if($userDetails->business_login_active==1)
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-header text-dark">Delete Business User</h4>
            </div>
            <form action="" role="form">
                <div class="modal-body">
                    <div class="form-group form-input-group m-t-5 m-b-5">
                        <p> Do you want to delete this Business User ?? </p>
                    </div>
                </div>
