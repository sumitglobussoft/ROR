                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="" role="form" id="edituserform">
                            ...
                            <div class="form-group m-t-10 m-b-5 col-md-6">
                                <label class="col-md-4 control-label">alternate_phone</label>
                                <div class="col-md-8">
                            ...
                            <table class="table table-striped font-14" id="datatable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="/admin/addreportuser/<?php echo $userDetails->user_id ?>"
                                           data-id="<?php echo $userDetails->user_id ?>" id=""
                                           class="btn btn-info addreport"> Add Report</a>
