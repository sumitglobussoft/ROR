                        ...
                        <form action="/admin/addreview" method="post" role="form">
                            ...
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <input type="hidden" name="addreportid" id="addreportid"
                                       class="form-control input-lg font-14" value="{{$reviewdata[0]->report_id}}">
                            </div>
                            <div class="form-group form-input-group m-t-30 m-b-5 col-md-10">
                                <label>Review Title</label>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="text-left">
                            <a href="/admin/listfilereport" class="btn btn-primary" data-toggle="modal"> Back to
                                Reports </a>
                        </div>
                        <div class="text-right">
                            <button class="btn btn-primary add-review" data-toggle="modal"><i class="fa fa-plus"></i>
                                Add Review
                            </button>
                        </div>
