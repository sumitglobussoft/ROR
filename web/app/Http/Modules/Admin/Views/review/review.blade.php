...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Reviews</div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="/admin/addreview" method="post" role="form" >
                            ...
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                <input type="hidden" name="addreportid" id="addreportid" class="form-control input-lg font-14" value="{{$reviewdata[0]->report_id}}" >
                            </div>
                            <div class="form-group form-input-group m-t-30 m-b-5 col-md-10">
                            <label>Review Title</label>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-left">
                            <h3> Report Title : {{$reporttitle}} </h3>
                        </div>
                         <div class="text-left">
                            <a href="/admin/listfilereport" class="btn btn-primary" data-toggle="modal" > Back to Reports </a>
                        </div>
        ...
        <div class="modal-content">
            ...
            <form action="/admin/addreview" method="post" role="form">
                <div class="modal-body">
                    <input type="text" name="addreportid" id="addreportid" class="form-control input-lg font-14" value="{{$reviewdata[0]->report_id}}" >
                    <div class="form-group form-input-group m-t-30 m-b-5">
