...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Unapproved Business Details</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tbody>
                                <?php    foreach ($allunapprovedBusiness as  $UnapprovedBusiness) {

                                ?>

                                <tr>
                                    <td><?php echo $UnapprovedBusiness->business_id;?></td>
                                    <td> <?php echo $UnapprovedBusiness->business_name;?></td>
                                    <td> <?php echo $UnapprovedBusiness->full_name;?></td>
                                    <td> <?php echo $UnapprovedBusiness->primary_phone;?></td>
                                    <td><?php echo $UnapprovedBusiness->category_name;?></td>
                                    <td><?php echo $UnapprovedBusiness->subcategory_name;?></td>
                                    <td><?php echo $UnapprovedBusiness->description;?></td>
                                    <td><?php echo $UnapprovedBusiness->address;?></td>
                                    <td><?php echo $UnapprovedBusiness->phone;?></td>
                                    <td><?php echo $UnapprovedBusiness->web_address;?></td>
                                    <td>
                                    <td class="text-center">
                                        @if($UnapprovedBusiness->status==2)
                                    ...
                                    <td class="text-center">
                                        <button data-toggle="modal" id="edituser"
                                                data-id="<?php echo $UnapprovedBusiness->business_id?>"
                                                class="btn btn-info edituserinfo">
                                            <i
                                                    class="fa fa-pencil"></i></button>
                                        <button data-id="<?php echo $UnapprovedBusiness->business_id?>" id=""
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-header text-dark">Delete Unapproved Business</h4>
            </div>
