...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">All Business Details</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tr>
                                    <td><?php echo $BusinessDetails->business_id;?></td>
                                    <td> <?php echo $BusinessDetails->business_name;?></td>
                                    <td> <?php echo $BusinessDetails->full_name;?></td>
                                    <td> <?php echo $BusinessDetails->primary_phone;?></td>
                                    ...
                                    <td class="text-center">
                                        <button data-toggle="modal" id="edituser"
                                                data-id="<?php echo $BusinessDetails->business_id?>"
                                                class="btn btn-info edituserinfo">
                                            <i
                                                    class="fa fa-pencil"></i></button>
                                        <button data-id="<?php echo $BusinessDetails->business_id?>" id=""
                                                data-toggle="modal" class="btn btn-danger deleteuser"><i
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-header text-dark">Delete Business</h4>
            </div>
...
//                        $.each(response.msg, function (index, value) {
//
//                            $('#edituserform').find("[name='" + index + "']").after('<span class="error">' + value + '</span>');
//                        });
//
//                    }
