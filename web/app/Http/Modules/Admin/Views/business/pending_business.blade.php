...
<div class="main-container">
    <div class="page-header no-breadcrumb font-header">Pending Business Details</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped font-12" id="datatable">
                                ...
                                <tbody>
                                <?php    foreach ($allpendingBusiness as  $PendingBusiness) {

                                ?>

                                <tr>
                                    <td><?php echo $PendingBusiness->business_id;?></td>
                                    <td> <?php echo $PendingBusiness->business_name;?></td>
                                    <td> <?php echo $PendingBusiness->full_name;?></td>
                                    <td> <?php echo $PendingBusiness->primary_phone;?></td>
                                    <td><?php echo $PendingBusiness->category_name;?></td>
                                    <td><?php echo $PendingBusiness->subcategory_name;?></td>
                                    <td><?php echo $PendingBusiness->description;?></td>
                                    ...
                                    <td class="text-center">
                                        <button data-toggle="modal" id="edituser"
                                                data-id="<?php echo $PendingBusiness->business_id?>"
                                                class="btn btn-info editBusinessinfo">
                                            <i
                                                    class="fa fa-pencil"></i></button>
                                        <button data-id="<?php echo $PendingBusiness->business_id?>" id=""
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-header text-dark">Delete Pendind Business</h4>
            </div>
