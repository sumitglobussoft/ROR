    ...
    <div class="pull-right">
        <ul id="mini-nav" class="clearfix" style="margin-top: 4%;">
            <li class="list-box user-profile">
                <a href="/user/login" class="btn btn-default" style="color: #000; padding: 14%;">LOGIN</a>
            </li>
            <li class="list-box user-profile">
                <a href="/user/register" class="btn btn-default" style="color: #000; padding: 10%;">REGISTER</a>
            </li>
        </ul>
    </div>
</header>
...
<div class="dashboard-container">
    ...
    <div class="container">
        ...
        <div class="sub-nav hidden-sm hidden-xs">
            <ul>
                <li><a href="/user/login" class="heading">LogIn</a></li>
            </ul>
