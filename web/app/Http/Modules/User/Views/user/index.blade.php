            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Lorem ipsum dolor sit amet, per modus perpetua instructior ne. Nam agam error pertinacia id, ea
                        graeco commodo recteque eam. Id eos oportere senserit, ut nec tantas sanctus definitiones.
                        Laoreet
                        admodum ut duo. Salutatus definitionem cu duo.
                    </p>

                    <p>Te delenit perfecto usu, mei esse ferri quidam in. Tantas scripta debitis vim no, ex nam unum
                        magna,
                        assum minimum cu vis. Vis error interpretaris no. Sit ei maluisset gubergren, ea debitis
                        scripserit
                ...
                <div class="col-md-4">
                    ...
                    <div id="question">
                        ...
                        <button type="button" class="btn" data-toggle="collapse" data-target="#demo4">What is a
                            question?
                                    ...
                                    <div class="panel panel-theme">
                                        <div class="panel-heading">
                                            <h5 class="title text-white">
                                                <span>{{$data->created_at}}</span> | <b>{{$data->display_name}}</b> |
                                                <span>{{$data->city}}</span>
                                            </h5>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <p class="text-center" style="margin-bottom: 0px;"><a
                                                        href="/details/{{$data->report_id}}"> Read More </a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
